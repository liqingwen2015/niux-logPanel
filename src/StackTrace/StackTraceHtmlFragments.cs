...
namespace NiuX.LogPanel.StackTrace
{
    partial class StackTraceHtmlFragments : IStackTraceFormatter<string>
    {
        ...
        string IStackTraceFormatter<string>.Text(string text) =>
        ...
        string IStackTraceFormatter<string>.ParameterType(string markup) =>
            BeforeParameterType + markup + AfterParameterType;

        string IStackTraceFormatter<string>.ParameterName(string markup) =>
            BeforeParameterName + markup + AfterParameterName;
    ...
    public static partial class StackTraceFormatter
    {
        private static readonly StackTraceHtmlFragments DefaultStackTraceHtmlFragments = new StackTraceHtmlFragments
        {
